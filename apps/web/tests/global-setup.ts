...
const SCHEMAS = ["001_init.sql", "004_clustering.sql", "008_chat.sql", "014_mobile_devices.sql"].map((file) =>
...
/**
 * Starts a throwaway Postgres with the real 001, 004, and 008 schemas and points the app at it.
 ...
 * The same goes for the AI keys (VT and Gemini): they are blanked unless CLUSTER_LIVE=1 or CHAT_LIVE=1,
...
export default async function setup() {
  ...
  if (process.env.CLUSTER_LIVE !== "1" && process.env.CHAT_LIVE !== "1") {
