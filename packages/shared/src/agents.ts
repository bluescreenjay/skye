// Response shapes for workspace agents (feature 010). The web app builds these; the Home card
// and the sidebar import them from `@ai-browser/shared` and must not redeclare them.
// Contract: specs/010-workspace-agents/contracts/shared-agent-types.md
// `PlanItem` is unchanged and lives in domain.ts. IDs are UUID strings; times are UTC ISO-8601 strings.
